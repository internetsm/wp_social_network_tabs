...
function dcsnt_networks($a)
{
	...
	$defaults['dribbble'] = Array('title' => 'Dribbble', 'follow' => 'Follow on Dribbble', 'limit' => 10, 'feed' => 'shots', 'accessToken' => '');
	...
	$defaults['instagram'] = Array('title' => 'Instagram', 'limit' => 10, 'thumb' => 'low_resolution', 'accessToken' => '', 'redirectUrl' => '', 'clientId' => '');
	...
	$help['dribbble'] = Array('id' => 'Enter a Dribbble username','title' => 'Text for header - leave blank to remove header', 'follow' => 'Text for follow button - leave blank to remove button', 'limit' => 'Maximum number of results', 'feed' => 'Data feed to be shown', 'accessToken' => 'Enter API access token');
